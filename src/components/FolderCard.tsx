...
export function FolderCard({ folder, itemCount, onOpen, onRename, onDelete, onMove, isDropTarget }: FolderCardProps) {
  ...
  return (
    <div
      ...
      style={{ gap: 8, padding: 8, outline: isDropTarget ? '2px solid var(--color-accent)' : 'none' }}
    >
