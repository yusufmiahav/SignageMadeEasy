...
// Icon paths lifted directly from the Modernist/SignageMadeEasy design reference
// (Lucide icon set, 2px stroke, round caps) so icons match the design pixel-for-pixel.
const PATHS = {
  ...
  image: '<rect x="3" y="3" width="18" height="18"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/>',
  calendar:
